...
class Quote:
    ...
    def __init__(
        ...
        cited_audio_start_time='',     # optional: number of seconds
        cited_video_start_time='',     # optional: number of seconds

        cited_transcript_url='',   # optional: transcript url
        citing_tags='',            # optional: custom tags
        cited_microformat_url='',  # optional: http://microformats.org/wiki/microformats2
        cited_title='',            # optional: title: "Patient Zero"
        cited_authors_entities='',    # optional: collective entity: "Radio Lab"
        cited_authors_entities_urls = '',  # optional: https://www.npr.org/series/121566675/radiolab, url2
        cited_authors_names='',       # optional: author names: comma separated
        cited_authors_urls='',             # optional: author homepage
        cited_authors_twitter='',          # optional: twitter homepage
        cited_authors_wikipedia_urls ='',  # optional: wikipedia url
        cited_author_wikipedia_url='',     # optional: author Wikipedia URL
        cited_series = '',         # optional: Series name
        cited_series_url = '',      # optional: Series urls=
        cited_series_youtube = '',  # optional: Series YouTube URL
        cited_event_date='',               # optional: date written/said
        cited_event_location='',  # optional: location name: Washington, DC (USA)
        cited_event_lattitue='',        # optional: lattitude: 40.7128
        cited_event_longitude='',       # optional: longitude: 74.0060
    ...
    self.start_time = time.time()    # measure elapsed time
        ...
        self.cited_transcript_url = cited_transcript_url
        self.citing_tags = citing_tags
        self.cited_microformat_url = cited_microformat_url
        self.cited_title = cited_title
        self.cited_authors_entities = cited_authors_entities
        self.cited_authors_entities_urls = cited_authors_entities_urls
        self.cited_authors_names = cited_authors_names
        self.cited_authors_urls = cited_authors_urls


        self.cited_authors-twitter = '',
        self.cited_authors_wikipedia_urls =

self.cited_author_wikipedia_url = cited_author_wikipedia_url
        self.cited_event_date = cited_event_date
        self.cited_event_location = cited_event_location
        self.cited_event_lattitue = cited_event_lattitue
        self.cited_event_longitude = cited_event_longitude
  ...
  ######################## Citing Document ############################
    ...
    def data(self, text_output=True, all_fields=True):
        ...
        data_dict = {
          ...
          'cited_audio_url': self.cited_audio_url,
          'cited_video_url': self.cited_video_url,
          'cited_transcript_url': self.cited_transcript_url,
          'citing_tags': self.citing_tags,
          'cited_authors_names': self.cited_authors_names,
          'cited_authors_urls': self.cited_authors_urls,
          'cited_author_wikipedia_url': self.cited_author_wikipedia_url,
          'cited_event_date': self.cited_event_date,
          'cited_event_location': self.cited_event_location,
          'cited_event_lattitue': self.cited_event_lattitue,
          'cited_event_longitude': self.cited_event_longitude
        }
